...
public class Equipments {
    ...
    public Equipment getWeapon(String weaponName) {
        if (weaponName.equals("sword_normal")) {
            return new Sword(pictures, 4, "剑", "普普通通的一把剑", "bm_sword_2");
        } else if (weaponName.equals("sword_bad"))
            return new Sword(pictures, 2, "渣渣剑", "比普通剑还坑爹的一把剑", "bm_sword_2");
        else if (weaponName.equals("sword_elite"))
            return new Sword(pictures, 10,"精良剑","进一步能获得的装备","bm_sword_2");
        return null;
    }
}
